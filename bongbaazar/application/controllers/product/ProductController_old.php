...
public function ShoesAllDiscount()
    ...
    public function SpecialCareAllDiscount()
    {
  	...
  	public function categoryAll($child_category_id)
  	{
    	...
    	$config=[
    		'base_url'=>base_url('category-all-product/'.$child_category_id),
    		'per_page'=>8,
    	...
    	$this->data["links"] = $this->pagination->create_links();
              ...
              //$this->data['menu_lebel'] = $this->Home_Model->get_categories();
              $this->data['prodct_all']=$this->Home_Model->ChildAllProduct_getRows($child_category_id,$config["per_page"],$page);
