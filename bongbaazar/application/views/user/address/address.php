          ...
          <div class="row">
                ...
                <?php foreach($allAddress as $key => $address_row){ ?>
                  ...
                  <div class="container-fluid">
                    <div class="product-single-item-innerpart">
                      ...
                      <a type="button" class="btn card-button-inner remove-btn" href="<?=base_url('address-destroy-order/'.$address_row->uniqcode)?>" onclick="return confirm('Are you sure delete this address?')">
                              <span>Remove</span>
                            </a>
                        <button type="button" class="btn card-button-inner edit-btn" onclick="editAddressOrder('<?=$address_row->uniqcode?>')">
                          <span>Edit</span>
                        </button>
                      </div>
                    </div>
            ...
            <div class="col-md-4 col-xs-12 col-sm-12">
              <div class="order-money">
                ...
                <div class="card-button">
                  <button type="button" class="btn card-button-inner address-btn  btn-block" id="prevBtn1" onclick="backPageCart()">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" id="address-add" action="<?=base_url('address-add-order')?>" method="post" enctype="multipart/form-data">
