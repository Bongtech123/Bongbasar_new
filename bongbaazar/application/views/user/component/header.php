                                ...
                                <div class="col-md-12 modal-form-underpart">
                                  ...
                                  <div id="forgot_form">
                                    ...
                                    <form  id="submit_forget" method="post" style="display:none;">
                                      ...
                                      <input type="text" class="form-control only_integer validate[required,maxSize[4],minSize[4]" id="fotp" name="fotp" placeholder="Enter your otp" data-errormessage-value-missing="OTP is required" data-prompt-position="bottomLeft" maxlength="200" onblur="otpcheck(this.value,'reg_mobile_no')" >
                  ...
                  <div class="row">
                   <form id="email_check" method="post" class="email_check1">
                    ...
                    <div class="col-lg-6" style="display:none" id="email_passwod1">
                        ...
                        <input type="text" name="email_passwod" id="email_passwod" class="form-control validate[required]" data-errormessage-value-missing="Password is required" data-prompt-position="bottomLeft" placeholder="Type Password" >
                        </div>
                    </div>
