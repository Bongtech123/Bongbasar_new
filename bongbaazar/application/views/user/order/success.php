            ...
            <div class="delivery-header">
                  <div class="row">
                      ...
                      <div class="card-button">
                          <a href="<?=base_url()?>" class="btn card-button-inner hvr-icon-down download-btn">
                              Go to order page
                              <!-- <i class="fa fa-download hvr-icon" aria-hidden="true"></i> -->
                              <i class="fa fa-shopping-bag hvr-icon" aria-hidden="true"></i>
                          </a>
                      </div>
                      <p class="bold-txt">Order placed successfully</p>
                      <p>Your item will be delivered by <span><?php echo date("D M d", strtotime($user_order_details->delivery_date));  ?></span></p>
                  </div>
              </div>
