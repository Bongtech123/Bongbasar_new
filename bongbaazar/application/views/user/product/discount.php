              ...
              <div id="accordion">
                  ...
                  <ul> 
                    <li class="search-in-box">
                      <div class="search-bar">
                        <input id="search_text_color_discount" class="searchbar" type="text" placeholder="Search...">
                ...
                <div class="accordianbody">
                  <ul> 
                    <li class="search-in-box">
                      <div class="search-bar">
                        <input id="search_text_size_discount" class="searchbar" type="text" placeholder="Search...">
                        <a id="btnSearch" class="btn-search"><i class="fa fa-search"></i></a>
                      </div>
                    </li>
                    <li>
                ...
                <div class="accordianbody">
                  <ul> 
                    <li class="search-in-box">
                      <div class="search-bar">
                        <input id="search_text_brand_discount" class="searchbar" type="text" placeholder="Search...">
                        <a id="btnSearch" class="btn-search"><i class="fa fa-search"></i></a>
                      </div>
                    </li>
                    <li>
