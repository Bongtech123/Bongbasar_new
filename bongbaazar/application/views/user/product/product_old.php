          ...
          <ul class="sidebar-nav">
                  ...
                  <ul>
                    <li>
                      <div class="aks-input-wrap">
                        <input class="aks-input" type="radio" id="radio1" name="radio" onclick="lowToHighFilter()">
                        <label class="aks-input-label" for="radio1">Price -- Low to High</label>
                      </div>
                    </li>
                    <li>
                      <div class="aks-input-wrap">
                        <input class="aks-input" type="radio" id="radio2" name="radio" onclick="highTolowFilter()">
                        <label class="aks-input-label" for="radio2">Price -- High to Low</label>
                      </div>
                    </li>
                    <li>
                      <div class="aks-input-wrap">
                        <input class="aks-input" type="radio" id="radio3" name="radio" onclick="atoz()">
                        <label class="aks-input-label" for="radio3">A to Z</label>
                      </div>
                    </li>
                    <li>
                      <div class="aks-input-wrap">
                        <input class="aks-input" type="radio" id="radio4" name="radio" onclick="ztoa()">
            ...
            <div class="price-filter">
              <div class="range-slider">
                  <input type="text" class="js-range-slider comon_selector" value=""/>
              </div>
