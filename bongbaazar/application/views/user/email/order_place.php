                                                            ...
                                                            <td class="mcnDividerBlockInner" style="min-width: 100%; padding: 9px 18px 0px;">
                                                                <table class="mcnDividerContent" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width: 100%;">
                                                                    <tbody>
																			        ...
																			        <tbody>
																			            ...
																			            <tr>
																			                ...
																			                <td style="float: left;">
																			                    ...
																			                    <p style="padding: 0px; margin: 0px; color: #00c174; font-family: arial; font-size: 12px; font-weight: bold;">Mon 9 Nov</p>
																			                </td>
																			            </tr>
																			            <tr>
																			            ...
																			            <tr>
																			                ...
																			                <td style="float: left;">
																			                    ...
																			                    <p style="padding: 0px 10px 0px 0; margin: 0px; color: #000000; font-family: arial; font-size: 12px; font-weight: bold; line-height: 18px;">
																			                        15/1, Russa road 3rd lane, Netajinagar, Rajendra Prasad Colony, Tollygunge, Kolkata, West Bengal, 700033, India
																			                    </p>
																			                    <p style="padding: 0px; margin: 0px;">
																			                        <span style="font-family: arial; font-size: 12px; color: #7e7e7e;"> Mobile No: <strong style="color: #000000; font-weight: bold;">+91 90******70</strong></span>
																			                    </p>
																			                </td>
																			            </tr>
																			            <tr>
																			            ...
																			            <tr>
																			                ...
																			                <td style="float: left;">
																			                    <p style="padding: 0px 0px 5px 0; margin: 0px; font-family: arial; font-size: 12px; color: #7e7e7e;">Payment Mode: <span style="color: #000000;">Prepaid</span>.</p>
																			                </td>
																			            </tr>
																			            <tr>
																			                <td colspan="2" height="26">&nbsp;</td>
                                                                        ...
                                                                        <tr>
																		    <td style="width: 100%;">
																		        <table border="0" width="100%" cellspacing="0" cellpadding="0" style="border: #e0e0e0 solid 1px; font-family: Arial; font-size: 12px; color: #000000; border-radius: 6px; width: 100%;">
																		            <tbody>
																		                <tr>
																		                    <td>
																		                                                            ...
																		                                                            <tbody style="line-height: 2">
																		                                                                <tr>
																		                                                                    <td align="left" valign="middle" style="font-family: arial; font-size: 12px;">
																		                                                                        Rice Lights Serial Bulbs Ladi Diwali Decoration Lighting (Set of 1) Multicolour for Indoor, Outdoor
																		                                                                    </td>
																		                                                                </tr>
																		                                                                <tr>
